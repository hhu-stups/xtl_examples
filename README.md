...
This repository contains examples for the Prolog animation mode of ProB.
...
Open one of the provided game specifications (Chess, Connect Four, Tic-Tac-Toe). Open SimB via `Advanced > SimB`, select a simulation configuration called `_interactive` and hit the play button.
